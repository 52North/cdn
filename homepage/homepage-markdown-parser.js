  ...
  function addMenuEntry(entry, div) {
      jQuery(div).append('<dt class="level1 parent opened forceopened first"><span class="outer"><span class="inner"><a onclick="loadSection(\'' + entry.key + '\')"><span>' + entry.label + '</span></a></span></span></dt>');
